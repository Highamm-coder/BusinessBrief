        ...
        <div className="max-w-6xl 2xl:max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 md:gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="w-11 h-11 bg-white rounded-full flex items-center justify-center text-[var(--slate)] hover:bg-gray-200 active:bg-gray-300 transition" aria-label="Instagram">
              ...
              <a href="#" className="w-11 h-11 bg-white rounded-full flex items-center justify-center text-[var(--slate)] hover:bg-gray-200 active:bg-gray-300 transition" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                </svg>
              </a>
              <a href="#" className="w-11 h-11 bg-white rounded-full flex items-center justify-center text-[var(--slate)] hover:bg-gray-200 active:bg-gray-300 transition" aria-label="LinkedIn">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
