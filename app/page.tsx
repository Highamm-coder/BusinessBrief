    ...
    <div className="min-h-screen">
      ...
      <footer className="bg-[var(--slate)] text-white py-8 2xl:py-10 px-6">
        <div className="max-w-6xl 2xl:max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 md:gap-4">
          <div className="h-8 sm:h-10 2xl:h-12 w-32 sm:w-40 2xl:w-48">
            <img
              src="/DeksiaWhiteLogo.svg"
              alt="Deksia"
              className="h-full w-full object-contain object-left md:object-center"
            />
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.instagram.com/deksia/?hl=en" target="_blank" rel="noopener noreferrer" className="w-11 h-11 bg-white rounded-full flex items-center justify-center text-[var(--slate)] hover:bg-gray-200 active:bg-gray-300 transition" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/Deksia" target="_blank" rel="noopener noreferrer" className="w-11 h-11 bg-white rounded-full flex items-center justify-center text-[var(--slate)] hover:bg-gray-200 active:bg-gray-300 transition" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                </svg>
              </a>
              <a href="https://www.linkedin.com/company/deksia" target="_blank" rel="noopener noreferrer" className="w-11 h-11 bg-white rounded-full flex items-center justify-center text-[var(--slate)] hover:bg-gray-200 active:bg-gray-300 transition" aria-label="LinkedIn">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
